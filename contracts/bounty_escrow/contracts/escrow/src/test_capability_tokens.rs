...
use crate::{
    BountyEscrowContract, BountyEscrowContractClient, CapabilityAction, DisputeReason, Error, EscrowStatus,
};
use soroban_sdk::{
...
fn test_claim_with_capability() {
    ...
    setup.client.authorize_claim(&2, &setup.recipient, &DisputeReason::Other);
...
fn test_capability_cannot_exceed_owner_authority() {
    ...
    setup.client.authorize_claim(&4, &setup.recipient, &DisputeReason::Other);
