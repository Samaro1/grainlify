...
fn test_authorize_claim_race_last_authorization_wins() {
    ...
    setup.escrow.authorize_claim(&bounty_id, &claimant_a, &DisputeReason::Other);
    setup.escrow.authorize_claim(&bounty_id, &claimant_b, &DisputeReason::Other);
...
fn test_claim_race_unauthorized_fails() {
    ...
    setup.escrow.authorize_claim(&bounty_id, &authorized, &DisputeReason::Other);
